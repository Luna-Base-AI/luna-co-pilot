...
type GlobalSettings = {
	...
	showLunaIgnoredFiles?: boolean | undefined
 ...
 * LunaCoPilotEvent
 */
declare enum LunaCoPilotEventName {
	Message = "message",
...
interface LunaCoPilotAPI extends EventEmitter<LunaCoPilotEvents> {
	/**
...
export {
	...
	type ProviderSettings,
	type LunaCoPilotAPI,
	LunaCoPilotEventName,
	type LunaCoPilotEvents,
	type LunaCoPilotSettings,
	type TokenUsage,
}
