...
export const recordSourceSchema = z.enum(["read_tool", "user_edited", "luna_edited", "file_mentioned"])
...
export const fileMetadataEntrySchema = z.object({
	...
	luna_read_date: z.number().nullable(),
	luna_edit_date: z.number().nullable(),
