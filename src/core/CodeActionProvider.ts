...
export const ACTION_NAMES = {
	EXPLAIN: "Luna Co-Pilot: Explain Code",
	FIX: "Luna Co-Pilot: Fix Code",
	FIX_LOGIC: "Luna Co-Pilot: Fix Logic",
	IMPROVE: "Luna Co-Pilot: Improve Code",
	ADD_TO_CONTEXT: "Luna Co-Pilot: Add to Context",
	NEW_TASK: "Luna Co-Pilot: New Task",
} as const

export const COMMAND_IDS = {
	EXPLAIN: "luna-co-pilot.explainCode",
	FIX: "luna-co-pilot.fixCode",
	IMPROVE: "luna-co-pilot.improveCode",
	ADD_TO_CONTEXT: "luna-co-pilot.addToContext",
	NEW_TASK: "luna-co-pilot.newTask",
} as const
