...
export const globalSettingsSchema = z.object({
	...
	showLunaIgnoredFiles: z.boolean().optional(),
...
const globalSettingsRecord: GlobalSettingsRecord = {
	...
	showLunaIgnoredFiles: undefined,
...
export const lunaCoPilotSettingsSchema = providerSettingsSchema.merge(globalSettingsSchema)

export type LunaCoPilotSettings = GlobalSettings & ProviderSettings
...
export type GlobalState = Omit<LunaCoPilotSettings, Keys<SecretState>>

export const GLOBAL_STATE_KEYS = [...GLOBAL_SETTINGS_KEYS, ...PROVIDER_SETTINGS_KEYS].filter(
	(key: Keys<LunaCoPilotSettings>) => !SECRET_STATE_KEYS.includes(key as Keys<SecretState>),
) as Keys<GlobalState>[]
...
export enum LunaCoPilotEventName {
	Message = "message",
...
export const lunaCoPilotEventsSchema = z.object({
	[LunaCoPilotEventName.Message]: z.tuple([
		z.object({
			taskId: z.string(),
	...
	[LunaCoPilotEventName.TaskCreated]: z.tuple([z.string()]),
	[LunaCoPilotEventName.TaskStarted]: z.tuple([z.string()]),
	[LunaCoPilotEventName.TaskModeSwitched]: z.tuple([z.string(), z.string()]),
	[LunaCoPilotEventName.TaskPaused]: z.tuple([z.string()]),
	[LunaCoPilotEventName.TaskUnpaused]: z.tuple([z.string()]),
	[LunaCoPilotEventName.TaskAskResponded]: z.tuple([z.string()]),
	[LunaCoPilotEventName.TaskAborted]: z.tuple([z.string()]),
	[LunaCoPilotEventName.TaskSpawned]: z.tuple([z.string(), z.string()]),
	[LunaCoPilotEventName.TaskCompleted]: z.tuple([z.string(), tokenUsageSchema, toolUsageSchema]),
	[LunaCoPilotEventName.TaskTokenUsageUpdated]: z.tuple([z.string(), tokenUsageSchema]),
	[LunaCoPilotEventName.TaskToolFailed]: z.tuple([z.string(), toolNamesSchema, z.string()]),
})

export type LunaCoPilotEvents = z.infer<typeof lunaCoPilotEventsSchema>
...
export const typeDefinitions: TypeDefinition[] = [
	...
	{ schema: lunaCoPilotEventsSchema, identifier: "LunaCoPilotEvents" },
]
