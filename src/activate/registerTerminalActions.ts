...
const TERMINAL_COMMAND_IDS = {
	ADD_TO_CONTEXT: "luna-co-pilot.terminalAddToContext",
	FIX: "luna-co-pilot.terminalFixCommand",
	FIX_IN_CURRENT_TASK: "luna-co-pilot.terminalFixCommandInCurrentTask",
	EXPLAIN: "luna-co-pilot.terminalExplainCommand",
	EXPLAIN_IN_CURRENT_TASK: "luna-co-pilot.terminalExplainCommandInCurrentTask",
} as const
...
export const registerTerminalActions = (context: vscode.ExtensionContext) => {
	...
	registerTerminalActionPair(
		...
		"TERMINAL_FIX",
		"What would you like Luna Co-Pilot to fix?",
	)
	...
	registerTerminalActionPair(
		...
		"TERMINAL_EXPLAIN",
		"What would you like Luna Co-Pilot to explain?",
	)
}
