...
export async function regexSearchFiles(
	...
	// Filter results using LunaIgnoreController if provided
	const filteredResults = lunaIgnoreController
		? results.filter((result) => lunaIgnoreController.validateAccess(result.file))
		: results
