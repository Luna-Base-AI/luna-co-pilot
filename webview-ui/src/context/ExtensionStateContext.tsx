...
import { ApiConfigMeta, ExtensionMessage, ExtensionState } from "@luna/shared/ExtensionMessage"
import { ApiConfiguration } from "@luna/shared/api"
import { vscode } from "@src/utils/vscode"
import { convertTextMateToHljs } from "@src/utils/textMateToHljs"
import { findLastIndex } from "@luna/shared/array"
import { McpServer } from "@luna/shared/mcp"
import { checkExistKey } from "@luna/shared/checkExistApiConfig"
import { Mode, CustomModePrompts, defaultModeSlug, defaultPrompts, ModeConfig } from "@luna/shared/modes"
import { CustomSupportPrompts } from "@luna/shared/support-prompt"
import { experimentDefault, ExperimentId } from "@luna/shared/experiments"
import { TelemetrySetting } from "@luna/shared/TelemetrySetting"
...
export interface ExtensionStateContextType extends ExtensionState {
	...
	setShowLunaIgnoredFiles: (value: boolean) => void
...
export const ExtensionStateContextProvider: React.FC<{ children: React.ReactNode }> = ({ children }) => {
	const [state, setState] = useState<ExtensionState>({
		...
		showLunaIgnoredFiles: true, // Default to showing .lunaignore'd files with lock symbol (current behavior).
	...
	const contextValue: ExtensionStateContextType = {
		...
		setShowLunaIgnoredFiles: (value) => setState((prevState) => ({ ...prevState, showLunaIgnoredFiles: value })),
