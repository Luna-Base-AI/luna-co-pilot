...
import {
	...
	ModeConfig,
	GroupEntry,
} from "@luna/shared/modes"
import { modeConfigSchema } from "@luna/schemas"
import { supportPrompt, SupportPromptType } from "@luna/shared/support-prompt"

import { TOOL_GROUPS, ToolGroup } from "@luna/shared/tools"
									...
									span: (
										<span
											...
											onClick={() => {
												...
												vscode.postMessage({
													type: "openFile",
													text: `./.luna/rules-${currentMode.slug}/rules.md`,
													values: {
														create: true,
														content: "",
													},
										...
										span: (
											<span
												...
												onClick={() => {
													...
													vscode.postMessage({
														type: "openFile",
														text: `./.luna/system-prompt-${currentMode.slug}`,
														values: {
															create: true,
															content: "",
														},
