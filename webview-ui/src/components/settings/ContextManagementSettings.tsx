...
type ContextManagementSettingsProps = HTMLAttributes<HTMLDivElement> & {
	...
	setCachedStateField: SetCachedStateField<
		"maxOpenTabsContext" | "maxWorkspaceFiles" | "showLunaIgnoredFiles" | "maxReadFileLine"
	>
}
	...
	return (
		<div className={cn("flex flex-col gap-2", className)} {...props}>
			...
			<Section>
				...
				<div>
					<VSCodeCheckbox
						checked={showLunaIgnoredFiles}
						onChange={(e: any) => setCachedStateField("showLunaIgnoredFiles", e.target.checked)}
						data-testid="show-lunaignored-files-checkbox">
						<label className="block font-medium mb-1">
							{t("settings:contextManagement.lunaignore.label")}
						</label>
					</VSCodeCheckbox>
					<div className="text-vscode-descriptionForeground text-sm mt-1">
						{t("settings:contextManagement.lunaignore.description")}
					</div>
				</div>
